...
[Claude Code](https://docs.claude.com/en/docs/claude-code) instalado (`npm install -g @anthropic-ai/claude-code`), ejecutándose en una terminal — el comando `/plugin` no está disponible en integraciones de IDE.
